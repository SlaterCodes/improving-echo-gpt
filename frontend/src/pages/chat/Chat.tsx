...
import Azure from "../../assets/Improving-simple-logo.svg";
                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is configured to answer your questions about Improving's enterprise playbook.</h2>
                            </Stack>
                        ) : (
